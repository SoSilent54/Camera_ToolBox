...
const FILE_DEFAULT_FILTER: &str = "warn,camera_toolbox_core=debug,camera_toolbox_app=debug,camera_toolbox_adapters=debug,camera_toolbox_logging=debug,camera_toolbox=debug,camera_toolbox_cli=debug,pongbot_calib_tool=debug";
