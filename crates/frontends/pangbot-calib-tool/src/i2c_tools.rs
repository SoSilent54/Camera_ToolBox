...
impl I2cToolsWorkspace {
    ...
    #[cfg(test)]
    pub(crate) fn selected_bus_for_test(&self) -> u32 {
        self.selected_bus
    }

    #[cfg(test)]
    pub(crate) fn buses_for_test(&self) -> &[I2cBusInfo] {
        &self.buses
    }
    ...
    #[cfg(test)]
    pub(crate) fn result_transactions_for_test(&self) -> Option<&[I2cTransactionResult]> {
        self.result
            .as_ref()
            .map(|report| report.transactions.as_slice())
    }
