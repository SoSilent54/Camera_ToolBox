...
pub(crate) struct X5RtspEncoderConfig {
    pub(crate) fps: u16,
    pub(crate) bitrate_kbps: u32,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct X5RtspApplySummary {
    pub(crate) apply_mode: String,
    pub(crate) fps: u16,
    pub(crate) bitrate_kbps: u32,
    pub(crate) pipeline_config_version: u64,
    pub(crate) action_id: Option<u64>,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct X5RtspStreamSummary {
    pub(crate) channel: Option<u16>,
    pub(crate) affected_channels: Vec<u16>,
    pub(crate) requested_enabled: bool,
    pub(crate) queued_action: String,
    pub(crate) worker_busy: bool,
    pub(crate) action_id: u64,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct X5DriverStatus {
    pub(crate) camera_running: bool,
    pub(crate) rtsp_started: bool,
    pub(crate) rtsp_tx_enabled: bool,
    pub(crate) rtsp_requested_enabled: bool,
    pub(crate) rtsp_control_busy: bool,
    pub(crate) rtsp_pending_action: String,
    pub(crate) rtsp_last_error: i64,
    pub(crate) rtsp_action_id: u64,
    pub(crate) rtsp_last_message: String,
    pub(crate) rtsp_channels: Vec<X5RtspChannelStatus>,
    pub(crate) rings: Vec<X5RingStatus>,
    pub(crate) fps: Option<u16>,
    pub(crate) bitrate_kbps: Option<u32>,
    pub(crate) pipeline_config_version: Option<u64>,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct X5RtspChannelStatus {
    ...
    pub(crate) busy: bool,
    pub(crate) pending_action: String,
    pub(crate) last_error: i64,
    pub(crate) action_id: u64,
    pub(crate) last_message: String,
    pub(crate) port: Option<u16>,
    pub(crate) rtsp_pts_valid: bool,
    pub(crate) rtsp_pts_origin_90k: u64,
    pub(crate) rtsp_pts_last_90k: u64,
    pub(crate) path: String,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct X5RingStatus {
    pub(crate) channel: u16,
    pub(crate) depth: u16,
    pub(crate) valid: u16,
    ...
    pub(crate) last_frame_id: u64,
    pub(crate) min_timestamp_ns: u64,
    pub(crate) max_timestamp_ns: u64,
    pub(crate) last_timestamp_ns: u64,
    pub(crate) last_rtsp_timestamp_us: u64,
    pub(crate) last_rtsp_pts_90k: u64,
    pub(crate) min_rtsp_pts_90k: u64,
    pub(crate) max_rtsp_pts_90k: u64,
    pub(crate) retention_ns: u64,
    pub(crate) dropped: u64,
    pub(crate) evicted: u64,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct X5YuvSnapshot {
    pub(crate) channel: u16,
    pub(crate) width: u32,
    pub(crate) height: u32,
    pub(crate) y_len: usize,
    pub(crate) uv_len: usize,
    pub(crate) frame_id: u64,
    pub(crate) timestamp_ns: u64,
    pub(crate) rtsp_timestamp_us: u64,
    pub(crate) rtsp_pts_90k: u64,
    pub(crate) match_rtsp_pts_delta_90k: Option<u64>,
    pub(crate) match_mode: Option<String>,
    pub(crate) payload: Vec<u8>,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct X5RawSnapshot {
    pub(crate) camera: u16,
    pub(crate) width: u32,
    pub(crate) height: u32,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct X5ProbeSummary {
...
pub(crate) fn probe(host: &str, port: u16) -> Result<X5ProbeSummary, String> {
...
pub(crate) fn status(host: &str, port: u16) -> Result<X5DriverStatus, String> {
...
pub(crate) fn start_rtsp_channel(
    host: &str,
    port: u16,
    channel: u16,
...
pub(crate) fn stop_rtsp_channel(
    host: &str,
    port: u16,
    channel: u16,
) -> Result<X5RtspStreamSummary, String> {
...
pub(crate) fn wait_for_rtsp_channels_ready(
    host: &str,
    port: u16,
    channels: &[u16],
...
pub(crate) fn capture_yuv_snapshot(
    host: &str,
    port: u16,
    channel: u16,
...
pub(crate) fn capture_yuv_snapshot_by_frame_id(
    host: &str,
    port: u16,
    channel: u16,
    frame_id: u64,
...
pub(crate) fn capture_yuv_snapshot_by_timestamp_ns(
    host: &str,
    port: u16,
    channel: u16,
    timestamp_ns: u64,
...
pub(crate) fn capture_yuv_snapshot_by_rtsp_pts_90k(
    host: &str,
    port: u16,
    channel: u16,
    rtsp_pts_90k: u64,
...
pub(crate) fn rtsp_channels_requiring_start(
...
pub(crate) fn capture_raw_snapshot(
    host: &str,
    port: u16,
    camera: u16,
    timeout_ms: u32,
