...
fn metrics_json(metrics: &StreamMetrics) -> Value {
    json!({
        ...
        "network_bytes_available": metrics.network_bytes_available,
        "network_bytes_per_second": metrics.network_bytes_per_second,
        "ffmpeg_media_bytes": metrics.ffmpeg_media_bytes,
        "ffmpeg_media_bytes_per_second": metrics.ffmpeg_media_bytes_per_second,
